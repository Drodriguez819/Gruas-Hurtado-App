...
from app import db
from app.models import ServiceRequest, ClientProfile, generate_service_request_number
...
def create_service_request():
    try:
        ...
        # Validate client_id is provided (required)
        ...
        # Generate sequential service request number
